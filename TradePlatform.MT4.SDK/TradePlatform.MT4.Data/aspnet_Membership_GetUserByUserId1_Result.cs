...
// Type: TradePlatform.MT4.Data.aspnet_Membership_GetUserByUserId1_Result
...
namespace TradePlatform.MT4.Data
{
  ...
  [EdmComplexType(Name = "aspnet_Membership_GetUserByUserId1_Result", NamespaceName = "TradePlatformModel")]
  [Serializable]
  public class aspnet_Membership_GetUserByUserId1_Result : ComplexObject
  {
    ...
    public static aspnet_Membership_GetUserByUserId1_Result Createaspnet_Membership_GetUserByUserId1_Result(bool isApproved, DateTime createDate, DateTime lastLoginDate, DateTime lastActivityDate, DateTime lastPasswordChangedDate, string userName, bool isLockedOut, DateTime lastLockoutDate)
    {
      return new aspnet_Membership_GetUserByUserId1_Result()
      {
