...
// Type: TradePlatform.MT4.Data.aspnet_UsersInRoles_RemoveUsersFromRoles1_Result
...
namespace TradePlatform.MT4.Data
{
  ...
  [EdmComplexType(Name = "aspnet_UsersInRoles_RemoveUsersFromRoles1_Result", NamespaceName = "TradePlatformModel")]
  [Serializable]
  public class aspnet_UsersInRoles_RemoveUsersFromRoles1_Result : ComplexObject
  {
    ...
    public static aspnet_UsersInRoles_RemoveUsersFromRoles1_Result Createaspnet_UsersInRoles_RemoveUsersFromRoles1_Result(string column1, string name)
    {
      return new aspnet_UsersInRoles_RemoveUsersFromRoles1_Result()
      {
        Column1 = column1,
        Name = name
      };
