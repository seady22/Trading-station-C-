...
// Type: TradePlatform.MT4.Data.aspnet_UsersInRoles_RemoveUsersFromRoles_Result
...
namespace TradePlatform.MT4.Data
{
  ...
  [EdmComplexType(Name = "aspnet_UsersInRoles_RemoveUsersFromRoles_Result", NamespaceName = "TradePlatformModel")]
  [Serializable]
  public class aspnet_UsersInRoles_RemoveUsersFromRoles_Result : ComplexObject
  {
    ...
    public static aspnet_UsersInRoles_RemoveUsersFromRoles_Result Createaspnet_UsersInRoles_RemoveUsersFromRoles_Result(string column1, string name)
    {
      return new aspnet_UsersInRoles_RemoveUsersFromRoles_Result()
      {
        Column1 = column1,
        Name = name
      };
