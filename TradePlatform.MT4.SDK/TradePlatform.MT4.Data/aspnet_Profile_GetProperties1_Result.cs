...
// Type: TradePlatform.MT4.Data.aspnet_Profile_GetProperties1_Result
...
namespace TradePlatform.MT4.Data
{
  ...
  [EdmComplexType(Name = "aspnet_Profile_GetProperties1_Result", NamespaceName = "TradePlatformModel")]
  [Serializable]
  public class aspnet_Profile_GetProperties1_Result : ComplexObject
  {
    ...
    public static aspnet_Profile_GetProperties1_Result Createaspnet_Profile_GetProperties1_Result(string propertyNames, string propertyValuesString, byte[] propertyValuesBinary)
    {
      return new aspnet_Profile_GetProperties1_Result()
      {
