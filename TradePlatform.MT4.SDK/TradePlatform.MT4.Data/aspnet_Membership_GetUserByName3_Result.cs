...
// Type: TradePlatform.MT4.Data.aspnet_Membership_GetUserByName3_Result
...
namespace TradePlatform.MT4.Data
{
  ...
  [EdmComplexType(Name = "aspnet_Membership_GetUserByName3_Result", NamespaceName = "TradePlatformModel")]
  [Serializable]
  public class aspnet_Membership_GetUserByName3_Result : ComplexObject
  {
    ...
    public static aspnet_Membership_GetUserByName3_Result Createaspnet_Membership_GetUserByName3_Result(bool isApproved, DateTime createDate, DateTime lastLoginDate, DateTime lastActivityDate, DateTime lastPasswordChangedDate, Guid userId, bool isLockedOut, DateTime lastLockoutDate)
    {
      return new aspnet_Membership_GetUserByName3_Result()
      {
