...
// Type: TradePlatform.MT4.Data.aspnet_Membership_GetUserByUserId_Result
...
namespace TradePlatform.MT4.Data
{
  ...
  [EdmComplexType(Name = "aspnet_Membership_GetUserByUserId_Result", NamespaceName = "TradePlatformModel")]
  [Serializable]
  public class aspnet_Membership_GetUserByUserId_Result : ComplexObject
  {
    ...
    public static aspnet_Membership_GetUserByUserId_Result Createaspnet_Membership_GetUserByUserId_Result(bool isApproved, DateTime createDate, DateTime lastLoginDate, DateTime lastActivityDate, DateTime lastPasswordChangedDate, string userName, bool isLockedOut, DateTime lastLockoutDate)
    {
      return new aspnet_Membership_GetUserByUserId_Result()
      {
